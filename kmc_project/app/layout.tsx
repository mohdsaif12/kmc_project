          ...
          <div className="bg-[#B23B25] text-white py-4 px-6 shadow-md border-b-4 border-[#800000]">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
              <a href="/" className="flex items-center gap-3 hover:opacity-90 transition-opacity">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-white rounded-full flex-shrink-0 flex items-center justify-center overflow-hidden border-2 border-white shadow-sm">
                  <img src="/logo.png" alt="KMCLU Logo" className="w-full h-full object-contain p-0.5" />
                </div>
